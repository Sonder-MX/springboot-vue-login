...
import com.example.backendproject.filters.RequestLogFilter;
import com.example.backendproject.service.AccountService;
...
public class SecurityConfiguration {
    ...
    private void handleProcess(HttpServletRequest request,
        ...
        if (exceptionOrAuthentication instanceof AccessDeniedException exception) {
            ...
            if (jwt == null) {
                writer.write(RestBean.forbidden("登录验证频繁，请稍后再试").toJsonStr());
            } else {
                TokenVO vo = account.asViewObject(TokenVO.class, o -> o.setToken(jwt));
                vo.setExpire(jwtUtils.expireTime());
                writer.write(RestBean.success(vo).toJsonStr());
            }
        }
    }
    ...
    private void onLogoutSuccess(HttpServletRequest request,
        ...
        writer.write(RestBean.failure(400, "退出登录失败").toJsonStr());
    }
